# Arm `INSTR_WORD_MOD_SUR|last_step` — Per-Arm Evidence

**Status:** ✓ CORRECT
**Audit:** Phase 7d Inc 5 — E5
**Generated:** 2026-06-14T03:05:49Z
...
**Row source**: `/root/arguzz/a4/runs/inc3_baseline/v5.db` mutation_id=26, variant=V5, step=3929
...
| Field | Value |
|---|---|
| Mutation config | `word=3061842035` |
| Mutation effect (new_word / new_kind / etc.) | `0xb6800073` |
...
- Reward v2 components: l_new=0, g_new=0, s_new=0.30475857599060807, scalar=0.18484542014866628
