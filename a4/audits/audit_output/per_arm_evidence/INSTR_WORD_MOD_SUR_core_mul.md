# Arm `INSTR_WORD_MOD_SUR|core_mul` — Per-Arm Evidence

**Status:** ✓ CORRECT
**Audit:** Phase 7d Inc 5 — E5
**Generated:** 2026-06-14T03:03:58Z
...
**Row source**: `/root/arguzz/a4/runs/inc3_baseline/v5.db` mutation_id=25, variant=V5, step=851
...
| txns at step | (19007, mem, 0x80c6e), (19008, reg, 0x3fffc029), (19009, reg, 0x3fffc022), (19010, reg, 0x3fffc029) |
...
| Field | Value |
|---|---|
| Mutation config | `word=431264915` |
| Mutation effect (new_word / new_kind / etc.) | `0x19b49493` |
...
- Reward v2 components: l_new=0, g_new=0, s_new=0.46283247050190834, scalar=0.10327188326498424
