# Arm `INSTR_WORD_MOD_FULL|post_ecall` — Per-Arm Evidence

**Status:** ✓ CORRECT
**Audit:** Phase 7d Inc 5 — E5
**Generated:** 2026-06-14T01:56:32Z
...
**Row source**: `/root/arguzz/a4/runs/inc3_baseline/v5.db` mutation_id=19, variant=V5, step=838
...
| txns at step | (18947, mem, 0x30000055), (18948, mem, 0x3fffc004), (18949, mem, 0x3fffc008), (18950, mem, 0x3fffc00b) |
...
| Field | Value |
|---|---|
| Mutation config | `word=1115817363` |
| Mutation effect (new_word / new_kind / etc.) | `0x42820593` |
...
- Reward v2 components: l_new=0, g_new=0, s_new=0.2994388408390165, scalar=0.18161883767767495
