# Arm `INSTR_WORD_MOD_FULL|core_arithmetic` — Per-Arm Evidence

**Status:** ✓ CORRECT
**Audit:** Phase 7d Inc 5 — E5
**Generated:** 2026-06-14T00:56:35Z
...
**Row source**: `/root/arguzz/a4/runs/inc3_baseline/v5.db` mutation_id=13, variant=V5, step=1172
...
| txns at step | (20339, mem, 0x822b4), (20340, reg, 0x3fffc022), (20341, reg, 0x3fffc030), (20342, reg, 0x3fffc028) |

### Independent re-decode

| Field | Value | Match cycle? |
|---|---|---|
| Raw instr word at PC | `0x03010413` | — |
...
| Field | Value |
|---|---|
| Mutation config | `word=587269139` |
| Mutation effect (new_word / new_kind / etc.) | `0x23010413` |
...
- Reward v2 components: l_new=0, g_new=0, s_new=0.30919579449162266, scalar=0.18753672921337575
