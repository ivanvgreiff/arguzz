...
| **D2.C** | V6/Arguzz integration: two-tier Arguzz kinds (V6-cTS=**11**, Hybrid=**4**) into bandit arm space + modernized V6-uniform driver (fresh re-run) | **DRAFT v0.4** → v0.5 LOCK (New_Master Phase 0) |
