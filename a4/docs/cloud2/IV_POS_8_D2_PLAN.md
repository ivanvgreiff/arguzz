...
| **D2.C** | V6 integration via Arguzz subprocess primitive + bridge + modernized v6_driver | `arguzz_invoke.py` + `mutations/arguzz_bridge.py` + `v6_uniform_driver.py` (modernized v6_driver_v2.py) | [`IV_POS_8_D2_C_SPEC.md`](./IV_POS_8_D2_C_SPEC.md) v0.5 LOCKED | D2.B closed | **DONE** (Batches 1–4, 2026-06-20) — 723 passed / 27 skipped baseline; ISS-8 local half resolved (F13); ISS-9 resolved; POS N=50 scale validation staged |
