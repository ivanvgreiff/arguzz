...
RUST_TOOLCHAIN_VERSION = "1.88.0"  # A1: bumped from 1.85.0 — a fresh dep-resolve pulls icu_*/idna_adapter 2.2 (need rustc>=1.86); 98387806 compiles cleanly under 1.88 (verified), and the host rustc does NOT affect the vulnerable circuit (committed generated code). Mounted over the image's settings.py for the MODE-2 build.
RISC0_PROVER = "local"  # "ipc", "bonsai"
GLOBAL_FAULT_INJECTION_ENV_KEY = "FAULT_INJECTION_ENABLED"
CONSTRAINT_TRACE_ENV_KEY = "CONSTRAINT_TRACE_ENABLED"
CONSTRAINT_CONTINUE_ENV_KEY = "CONSTRAINT_CONTINUE"
