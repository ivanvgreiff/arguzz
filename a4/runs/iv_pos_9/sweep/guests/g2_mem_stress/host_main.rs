// =============================================================================
// IV.POS.9 Track-B  Guest 2 host (memory-stress) — host_main.rs
...
struct Args {
    ...
    inject: bool,
    #[clap(long)]
    seed: Option<u64>,             // INJECTION seed (Arguzz/A4 fault path)
    #[clap(long)]
    ...
    // ---- Guest-2 inputs ----
    #[clap(long)]
    gseed: u32,                    // array/accumulator seed
    #[clap(long)]
    mask: u32,                     // XOR mask for phase-1 stores
    #[clap(long)]
    rounds: u32,                   // phase-2 iteration count (clamped in guest)
}
