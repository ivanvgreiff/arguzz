...
#
# ### TRACK-B COPY (IV.POS.9 multi-guest sweep) — do NOT edit the shared a4/pos/chain_dispatcher.sh. ###
# Frozen copy of a4/pos/chain_dispatcher.sh so Track B (sweep) and Track A (bug-race) never edit
# each other's POS dispatch logic. Track A uses a4/pos/chain_dispatcher.sh; Track B uses THIS one.
#
